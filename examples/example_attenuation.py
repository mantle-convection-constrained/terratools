...
if __name__ == "__main__":
    ...
    geotherm = np.loadtxt("../terratools/properties/data/anderson_82.txt", unpack=True)
    depths = geotherm[0]
    ...
    prem_QS_L6 = prem[7]
    ax[3].plot(
        prem_depths / 1.0e3, prem_QS_L6, label="QS (QL6; Durek and Ekstrom, 1996)"
    )
    ax[3].plot(
        prem_depths / 1.0e3, prem_QK_L6, label="QK (QL6; Durek and Ekstrom, 1996)"
    )
